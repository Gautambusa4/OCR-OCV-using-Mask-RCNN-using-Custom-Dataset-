...
def train(model):
    ...
    dataset_train.load_custom("C:/Users/gauta/Downloads/mask_rcnn_polygon/dataset", "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = CustomDataset()
    dataset_val.load_custom("C:/Users/gauta/Downloads/mask_rcnn_polygon/dataset", "val")
    dataset_val.prepare()
